...
define('BOT_TOKEN', '248448327:AAHFwEozMtUaBAPmSlop80M8CcAiUongnS0');
...
کانلا ما  👈        [@TeleSync](https://telegram.me/SyncTeam)

🔹هر نفر = یک ربات ✖️
🔸ربات دوم = 5000ت ✔️
🤖 @PVSync_Bot',"parse_mode"=>"MARKDOWN","disable_web_page_preview"=>"true"));
...
🗣پیام ارسال شد");
        ...
        file_put_contents($id.'/Luncher.php',$phptext);
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'$texttwebhook?url=');
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://TeleSync-051.rhcloud.com//'.$chat_id.'/Luncher.php');
...
🗣پیام ارسال شد");
        ...
        $phptext = str_replace("**ADMIN**",$chat_id,$phptext);
        file_put_contents($token.$id.'/Luncher.php',$phptext);
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=');
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://TeleSync-051.rhcloud.com//'.$chat_id.'/Luncher.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=PVSync_Bot
.";
    
    $bot_url    = "https://api.telegram.org/bot248448327:AAHFwEozMtUaBAPmSlop80M8CcAiUongnS0/"; 
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://TeleSync-051.rhcloud.com//'.$id.'/Luncher.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=PVSync_Bot
